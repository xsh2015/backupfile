...
public  class Backup {
	...
	// private  static String cf="No";
	// private static String format="YYYY";
	 private  static String exclude="c:\\$Recycle.Bin";
	 //private  static String exclude2="$RECYCLE.BIN";
...
public static void ftpBackup(String myfile,String myftpserver,int myport,String myuser,String mypassword){
	...
	String fileShortName=myfile.substring(myfile.lastIndexOf("\\")+1,myfile.length());
	//String mydest=getLocalMac(
	try {
	
 	//input = new FileInBufferedInputStreamputStream(myfile);
 	//remote=getRemote();
            	...
            	String mydir=getLocalMac();
     	 	    ...
     	 	    if(mydir!=null) {
     	 	    	...
     	 	    	if(ftp.changeWorkingDirectory(mydir))
     	 	    		...
     	 	    		System.out.println("ftp change dir successful!");
     	 	    }else
